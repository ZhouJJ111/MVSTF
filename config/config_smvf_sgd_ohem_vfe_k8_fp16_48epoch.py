def get_config():
    class General:
        ...
        # SeqDir = '/home/hddData/zjjData/SemanticKITTI/dataset/sequences'
        SeqDir = '/home/TrueNasDir/zhoujj/DataSets/SemanticKITTI/dataset/sequences'
        category_list = ['static', 'moving']
        category_list_single = ["car", "bicycle", "motorcycle", "truck", "other-vehicle",
    ...
    class ModelParam:
        ...
        class_num = len(category_list) + 1                      # 2+1=3
        category_list_single = General.category_list_single
        class_num_single = len(category_list_single) + 1        # 19+1=20
        loss_mode = General.loss_mode
        seq_num = General.K + 1                 # 9
        ...
        class BEVParam:
            ...
            layers = [2, 3, 4]
            bev_grid2point = dict(type='BilinearSample', scale_rate=(0.5, 0.5))   # (0.5, 0.5)
